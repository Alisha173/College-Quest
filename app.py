...
# Load college data
college_data = pd.read_csv('CSV files\\first_500_colleges.csv')
info_data = pd.read_csv('CSV files\\info_data_500.csv')
admission_data = pd.read_csv('CSV files\\adm2024_500.csv')
course_fees_data = pd.read_csv('CSV files\\coursefees500.csv')
cutoff_data = pd.read_csv('CSV files\\cutoff_marks_500.csv')
departments_data = pd.read_csv('CSV files\\departments_500.csv')
distance_data = pd.read_csv('CSV files\\distance_education_500.csv')
faculty_data = pd.read_csv('CSV files\\faculty_data_500.csv')
gallery_data = pd.read_csv('CSV files\\gallery_data_500.csv')
hostel_data = pd.read_csv('CSV files\\hostel_data_500.csv')
news_data = pd.read_csv('CSV files\\news_articles_data_500.csv')
placement_data = pd.read_csv('CSV files\\placement_data_500.csv')
ranking_data = pd.read_csv('CSV files\\ranking_data_500.csv')
reviews_data = pd.read_csv('CSV files\\reviews_500.csv')
scholarship_data = pd.read_csv('CSV files\\scholarship_data_500.csv')
qa_data = pd.read_csv('CSV files\\qa_data_500.csv')
...
def info(college_id): 
    if 'user' not in session:
        return redirect(url_for('login'))
    college=Colleges.query.get(college_id)
